...
namespace SpAktarim.Data.Entities
{
    public class File
    {
        ...
        public long FolderID { get; set; } //(long, not null)
        ...
        public string FileDirRef { get; set; } //(nvarchar(max), null)
        ...
        public string FileType { get; set; } //(nvarchar(10), null)
        public long FileSize { get; set; } //(long, null)
        public bool Aktarildimi { get; set; } //(bit, not null)
    }
